...
void ACTION_Wn(void)
{
    ...
    pVfo->CHANNEL_BANDWIDTH = pVfo->CHANNEL_BANDWIDTH == BANDWIDTH_WIDE ? BANDWIDTH_NARROW :
        (pVfo->CHANNEL_BANDWIDTH == BANDWIDTH_NARROW ? BANDWIDTH_NARROWER : BANDWIDTH_WIDE);
